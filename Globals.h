...
#define REQUEST_ARRAY_REQUEST_KEY "request"
#define REQUEST_REQUEST_TYPE_KEY "type"
#define REQUEST_REQUEST_TYPE_VALUE_INVALID invalid
#define REQUEST_REQUEST_TYPE_VALUE_POST post
#define REQUEST_REQUEST_TYPE_CONSTANT_POST 1
#define REQUEST_REQUEST_TYPE_VALUE_LOG log
#define REQUEST_REQUEST_TYPE_CONSTANT_LOG 2
#define REQUEST_REQUEST_PERIOD_KEY "period"
